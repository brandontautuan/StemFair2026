          ...
          <div className="speakers-grid">
            <div className="speaker-card">
              <div className="speaker-image">
                <img src="/template_profile_picture.jpg" alt="Speaker 1" />
              </div>
            ...
            <div className="speaker-card">
              <div className="speaker-image">
                <img src="/template_profile_picture.jpg" alt="Speaker 2" />
              </div>
              <h3 className="speaker-name">Speaker Name</h3>
              <p className="speaker-title">Title/Organization</p>
              <p className="speaker-bio">Brief bio or topic description will appear here.</p>
            ...
            <div className="speaker-card">
              <div className="speaker-image">
                <img src="/template_profile_picture.jpg" alt="Speaker 3" />
              </div>
              <h3 className="speaker-name">Speaker Name</h3>
              <p className="speaker-title">Title/Organization</p>
              <p className="speaker-bio">Brief bio or topic description will appear here.</p>
            ...
            <div className="speaker-card">
              <div className="speaker-image">
                <img src="/template_profile_picture.jpg" alt="Speaker 4" />
              </div>
              <h3 className="speaker-name">Speaker Name</h3>
              <p className="speaker-title">Title/Organization</p>
              <p className="speaker-bio">Brief bio or topic description will appear here.</p>
